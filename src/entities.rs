...
#[derive(Debug, PartialEq, Eq)]
pub struct DaletString<N> {
    pub contents: std::string::String,
    _n: PhantomData<N>,
}

impl<BigUInt: N> DaletString<N> {
    #[allow(dead_code)]
    pub fn base() -> N {
        N::from(256usize)
    }
...
#[derive(Debug, PartialEq, Eq)]
pub struct HContents<N> {
    pub tbody: TBody<N>,
    pub hl: Hl<N>,
}

impl<N: BigUInt> HContents<N> {
    #[allow(dead_code)]
    pub fn base() -> N {
        TBody::base::<N>()
    }
...
#[derive(Debug, PartialEq, Eq)]
pub struct RowContents<N> {
    pub tags: TagSequence<N>,
    pub alignment: AlignArg<N>,
}

impl<N: BigUInt> RowContents<N> {
    #[allow(dead_code)]
    pub fn base() -> N {
        TagSequence::base::<N>()
    }
...
#[derive(Debug, PartialEq, Eq)]
pub struct LinkContents<N> {
    pub body: Body<N>,
    pub targ: TArg<N>,
}

impl<N: BigUInt> LinkContents<N> {
    #[allow(dead_code)]
    pub fn base() -> N {
        Body::base::<N>()
    }
...
#[derive(Debug, PartialEq, Eq)]
pub struct NavlinkContents<N> {
    pub body: Body<N>,
    pub targ: TArg<N>,
}

impl<N: BigUInt> NavlinkContents<N> {
    #[allow(dead_code)]
    pub fn base() -> N {
        Body::base::<N>()
    }
...
#[derive(Debug, PartialEq, Eq)]
pub struct BtnContents<N> {
    pub body: Body<N>,
    pub targ: TArg<N>,
}

impl<N: BigUInt> BtnContents<N> {
    #[allow(dead_code)]
    pub fn base() -> N {
        Body::base::<N>()
    }
...
#[derive(Debug, PartialEq, Eq)]
pub struct FootnContents<N> {
    pub tbody: TBody<N>,
    pub nnarg: NNArg<N>,
}

impl<N: BigUInt> FootnContents<N> {
    #[allow(dead_code)]
    pub fn base() -> N {
        TBody::base::<N>()
    }
...
#[derive(Debug, PartialEq, Eq)]
pub struct NavbtnContents<N> {
    pub body: Body<N>,
    pub targ: TArg<N>,
}

impl<N: BigUInt> NavbtnContents<N> {
    #[allow(dead_code)]
    pub fn base() -> N {
        Body::base::<N>()
    }
...
#[derive(Debug, PartialEq, Eq)]
pub struct BlockContents<N> {
    pub nnbody: NNBody<N>,
    pub alignment: AlignArg<N>,
}

impl<N: BigUInt> BlockContents<N> {
    #[allow(dead_code)]
    pub fn base() -> N {
        NNBody::base::<N>()
    }
...
#[derive(Debug, PartialEq, Eq)]
pub struct CodeContents<N> {
    pub tbody: TBody<N>,
    pub tnullarg: TNullArg<N>,
}

impl<N: BigUInt> CodeContents<N> {
    #[allow(dead_code)]
    pub fn base() -> N {
        TBody::base::<N>()
    }
...
#[derive(Debug, PartialEq, Eq)]
pub struct MetaContents<N> {
    pub tbody: TBody<N>,
    pub targ: TArg<N>,
}

impl<N: BigUInt> MetaContents<N> {
    #[allow(dead_code)]
    pub fn base() -> N {
        TBody::base::<N>()
    }
...
pub enum Tag<N> {
    ...
    Row(RowContents<N>),
    Link(LinkContents<N>),
    Navlink(NavlinkContents<N>),
    Btn(BtnContents<N>),
    Navbtn(NavbtnContents<N>),
    Img(TArg<N>),
    Table(TagSequence<N>),
    Trow(TagSequence<N>),
    Tprow(TagSequence<N>),
